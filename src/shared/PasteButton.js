...
import { PasteButton, PasteButtonLabel } from './../shared'
...
export default class PasteBtn extends PureComponent {
  ...
  pasteHandler = async ()=> {
    ...
    this.refs.pasteButtonView
      .fadeOutLeft(300)
      .then(() => setAccountValue(content), ()=> {
        Keyboard.dismiss();
      });
  }
  ...
  render() {
    ...
    if (!account || account === "") {
      return (
        <Animatable.View ref="pasteButtonView" style={{ position: 'absolute', marginTop: 18, marginLeft: -6 }}>
