...
import { ContainerFlex, Card, CloseButton, AddTransactionInput, AddTransactionHeaderLabel, ErrorLabel } from './../../shared'
  ...
  render() {
    ...
    return (
      <ContainerFlex>
            ...
            maxWidth={100}
            style={{ marginLeft: 16, borderWidth: 0, alignSelf: 'center', marginTop: 16 }}
          />
      </ContainerFlex>
    )
  }
